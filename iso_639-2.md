...
[Drieletteringe codes talen](https://nl.wikipedia.org/wiki/ISO_639#ISO_639-2). Totaal 487 ISO-codes, 100% zijn vertaald op 2021-08-26 13:04:31 UTC.
...
`Name for ang` | `English, Old (ca. 450-1100)` | `Oudengels (ca. 450-1100)`
`Name for anp` | `Angika` | `Angika`
`Name for apa` | `Apache languages` | `Apache-talen`
`Name for ara` | `Arabic` | `Arabisch`
`Name for arc` | `Official Aramaic (700-300 BCE); Imperial Aramaic (700-300 BCE)` | `Officieel Aramees (700-300 v.Chr.); Keizerlijk Aramees (700-300 v.Chr.)`
`Name for arg` | `Aragonese` | `Aragonees`
`Name for arn` | `Mapudungun; Mapuche` | `Mapudungun; Mapuche`
...
`Name for ast` | `Asturian; Bable; Leonese; Asturleonese` | `Asturisch; Bable; Leonees; Astur-Leonees`
...
`Name for nav` | `Navajo; Navaho` | `Navajo; Navaho`
