...
[Drieletteringe codes valuta's](https://nl.wikipedia.org/wiki/ISO_4217). Totaal 170 ISO-codes, 100% zijn vertaald op 2021-08-26 13:04:31 UTC.

Codebeschrijving | Engels | Nederlands
---|---|---
`Name for AED` | `UAE Dirham` | `VAE-Dirham`
`Name for AFN` | `Afghani` | `Afghani`
`Name for ALL` | `Lek` | `Lek`
`Name for AMD` | `Armenian Dram` | `Armeense dram`
`Name for ANG` | `Netherlands Antillean Guilder` | `Antilliaanse gulden`
`Name for AOA` | `Kwanza` | `Angolese kwanza`
`Name for ARS` | `Argentine Peso` | `Argentijnse peso`
`Name for AUD` | `Australian Dollar` | `Australische dollar`
`Name for AWG` | `Aruban Florin` | `Arubaanse gulden`
`Name for AZN` | `Azerbaijanian Manat` | `Azerbeidzjaanse manat`
`Name for BAM` | `Convertible Mark` | `Converteerbare marken`
`Name for BBD` | `Barbados Dollar` | `Barbadiaanse dollar`
`Name for BDT` | `Taka` | `Bengalese taka`
`Name for BGN` | `Bulgarian Lev` | `Bulgaarse lev`
`Name for BHD` | `Bahraini Dinar` | `Bahreinse dinar`
`Name for BIF` | `Burundi Franc` | `Burundese frank`
`Name for BMD` | `Bermudian Dollar` | `Bermuda-dollar`
`Name for BND` | `Brunei Dollar` | `Bruneise dollar`
`Name for BOB` | `Boliviano` | `Boliviaanse boliviano`
`Name for BRL` | `Brazilian Real` | `Braziliaanse real`
`Name for BSD` | `Bahamian Dollar` | `Bahamaanse dollar`
`Name for BTN` | `Ngultrum` | `Bhutaanse ngultrum`
`Name for BWP` | `Pula` | `Botswaanse pula`
`Name for BYN` | `Belarusian Ruble` | `Wit-Russische roebel`
`Name for BZD` | `Belize Dollar` | `Belizaanse dollar`
`Name for CAD` | `Canadian Dollar` | `Canadese dollar`
`Name for CDF` | `Congolese Franc` | `Kongolese franc`
`Name for CHF` | `Swiss Franc` | `Zwitserse frank`
`Name for CLP` | `Chilean Peso` | `Chileense peso`
`Name for CNY` | `Yuan Renminbi` | `Chinese renminbi yuan`
`Name for COP` | `Colombian Peso` | `Colombiaanse peso`
`Name for CRC` | `Costa Rican Colon` | `Costaricaanse colón`
`Name for CUC` | `Peso Convertible` | `Converteerbare peso`
`Name for CUP` | `Cuban Peso` | `Cubaanse peso`
`Name for CVE` | `Cabo Verde Escudo` | `Kaapverdische escudo`
`Name for CZK` | `Czech Koruna` | `Tsjechische kroon`
`Name for DJF` | `Djibouti Franc` | `Djiboutiaanse frank`
`Name for DKK` | `Danish Krone` | `Deense kroon`
`Name for DOP` | `Dominican Peso` | `Dominicaanse peso`
`Name for DZD` | `Algerian Dinar` | `Algerijnse dinar`
`Name for EGP` | `Egyptian Pound` | `Egyptisch pond`
`Name for ERN` | `Nakfa` | `Eritrese nakfa`
`Name for ETB` | `Ethiopian Birr` | `Ethiopische birr`
`Name for EUR` | `Euro` | `euro`
`Name for FJD` | `Fiji Dollar` | `Fiji-dollar`
`Name for FKP` | `Falkland Islands Pound` | `Falklandeilands pond`
`Name for GBP` | `Pound Sterling` | `pond sterling`
`Name for GEL` | `Lari` | `Georgische lari`
`Name for GHS` | `Ghana Cedi` | `Ghanese cedi`
`Name for GIP` | `Gibraltar Pound` | `Gibraltarees pond`
`Name for GMD` | `Dalasi` | `Gambiaanse dalasi`
`Name for GNF` | `Guinea Franc` | `Guinese frank`
`Name for GTQ` | `Quetzal` | `Guatemalaans quetzal`
`Name for GYD` | `Guyana Dollar` | `Guyaanse dollar`
...
`Name for SBD` | `Solomon Islands Dollar` | `Salomon-dollar`
